...
We should always make a website accessible to people with dissabilities. We have different ways to let people enjoy our website.

2. Talk about 3 different things you can do to ensure your website is accessible. 

 Allowing them to use screen readers, using neutral colors, being responsive in different divices, describing images.

3. How would you explain the concept of a variable to someone new to programming?

A variable is a container. A box where you put things in. An "object" you assign values to.

4. What is the purpose of using functions in code?

DRY - Do not repeat yourself.
To make code easier to read. To reuse code.
